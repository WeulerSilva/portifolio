...
function finishQuiz() {
  ...
  if (points === 0) {
    ...
    if (languageEng) {
      document.querySelector('.score-text').innerHTML = 'You are about to reach 100% of the questions. The impossible will be possible -coach random!';
    } else {
    ...
    if (languageEng) {
      document.querySelector('.score-text').innerHTML = 'Wow, You did it, take your prize here:';
    } else {
  ...
  if (languageEng) {
    ...
    document.querySelector('.score-text-two').innerHTML = `you answered ${questions.length} and hit ${correctAnswer}`
